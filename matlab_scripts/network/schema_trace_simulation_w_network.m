...
%%% [x,y,flavor_ind,flavor_in_order]=schema_trace_simulation_w_network('Schema A');

function [x,y,flavor_ind,flavor_in_order]=schema_trace_simulation_w_network(SchemaName)
...
if (new_flavor_added == true)
    ...
    network = network_tse(flavor_ind,flavor_in_order,network);
end
